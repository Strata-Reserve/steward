...
Update the default policies for a tenant. The historical `webhookUrl` field is retired and returns HTTP 410; it could not securely provision a receiver-known signing secret.
