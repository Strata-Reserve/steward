...
Supported transaction-signing API routes pass through the [Policy Engine](/concepts/policy-engine) before invoking the Vault. Compatibility signing routes may instead require MFA, signer permission, and explicit unsafe feature flags:
