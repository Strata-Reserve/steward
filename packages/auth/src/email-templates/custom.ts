...
function substitute(template: string, values: Record<string, string>, escapeHtml: boolean): string {
...
export function otpTemplateValues(data: OtpTemplateData): Record<string, string> {
  return {
    code: data.code,
    email: data.email,
